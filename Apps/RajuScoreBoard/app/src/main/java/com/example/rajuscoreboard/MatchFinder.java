...
public class MatchFinder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MatchFinder.Doregister doregister = new MatchFinder.Doregister();
                doregister.execute("");
            }
        });
    }
    ...
    public class Doregister extends AsyncTask<String,String,String>
    {
        ...
        protected void onPostExecute(String s) {
            ...
            startActivity(new Intent(MatchFinder.this,PlayerList.class));
            progressDialog.hide();
        }
    }
    ...
    private class Dologin extends AsyncTask<String,String,String>{
        ...
        protected void onPostExecute(String s) {
            ...
            if(isSuccess) {
                Intent intent=new Intent(MatchFinder.this,PlayerList.class);
